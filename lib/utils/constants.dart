const String configTableName = "configTable";
const String idColumn = "idColumn";
const String ipColumn = "ipColumn";
const String itemAvaliadoColumn = "itemAvaliadoColumn";

const String tipoTableName = "tipoAvaliacao";
const String idTipoColumn = "idTipoColumn";
const String idTipoAvaliacaoColumn = "idTipoAvaliacaoColumn";
